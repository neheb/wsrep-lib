...
namespace wsrep
{
    ...
    public:
         ...
         *
         * The value set by keep_current_error() has an effect on
         * how before_command() behaves when it is entered after
         * background rollback has been processed:
         *
         * - If keep_command_error has been set true, the current error
         *   is set and success will be returned.
         * - If keep_command_error has been set true, the transaction is
         *   cleaned up and the return value will be non-zero to indicate
         *   error.
         *
        ...
        /**
         * Make client state to preserve error state in command hooks.
         * This is needed if a current command is not supposed to return
         * an error status to the client and the protocol must advance
         * until the next client command to return error status.
         */
        void keep_command_error(bool val)
        {
            keep_command_error_ = val;
        }
